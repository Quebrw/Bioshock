...
public class LoadLevel {
    ...
    public LoadLevel(){
        ...
        this.addObject(6, new worldObjects(50, 50, new Vector2f(301, 300), new Vector2f(749, 550), "enemy", 20, new Vector2f(4 , 0)));
        this.addObject(6, new worldObjects(50, 50, new Vector2f(1301, 300), new Vector2f(1920, 550), "enemy", 20, new Vector2f(4 , 0)));
        this.addObject(6, new worldObjects(50, 50, new Vector2f(800, 501), new Vector2f(1300, 501), "enemy", 20, new Vector2f(4 , 0)));
